...
function createDecisionBlock(x, y, width, height, question, answerA, answerB) {
    ...
    childA = {start_x: x, start_y: y + h + h_extra, width: width / 2, height: height - h - extra_h};
    childB = {start_x: x + width / 2, start_y: y + h + extra_h, width: width / 2, height: height - h - extra_h};
